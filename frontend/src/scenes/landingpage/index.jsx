import { Box, Typography, useMediaQuery, IconButton, Grid} from "@mui/material";
...
import lp_image from "../../assest/lp_image.png";
...
const LandingPage = () => {
    ...
    >
        ...
        <Card sx={{ padding: "2rem", maxWidth: 360, borderRadius: '16px'}}>
            ...
            <CardActions>
                <Grid container justifyContent="center">
                <Button size="large" variant="contained" color="primary" href="#contained-buttons">Continue</Button>
                </Grid>
            </CardActions>
        </Card>
        </Box>
