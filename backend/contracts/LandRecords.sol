...
contract LandRecords {
    ...
    function requestforBuy(uint _landId) public
    {
        ...
        totalRequestCount++;
        BuyRequest[totalRequestCount]=landBuyRequest(totalRequestCount,msg.sender,lands[_landId].landOwner,reqStatus.pending);
    ...
    function acceptRequest(uint _requestId) public
    {
        ...
        transferCount++;
        TransferRequest[transferCount] = landTrasferRequest(BuyRequest[_requestId].landId,msg.sender,BuyRequest[_requestId].buyerId,reqStatus.pending);
